                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    <h2 class="card-title mb-4">Đăng ký Admin</h2>
                                    <?php
                                    ...
                                    ?>
                                    <form method="post" action="process/process-admin-create.php">
                                        <div class="position-relative row form-group">
                                            <label for="username" class="col-md-3 text-md-right col-form-label">Username</label>
                                            <div class="col-md-9 col-xl-8">
                                                <input required name="username" id="username" placeholder="Username" type="text" class="form-control" value="">
                                            </div>
                                        </div>
