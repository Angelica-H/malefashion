                        ...
                        <div class="col-md-12">
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if (!empty($name)) {
                                    ...
                                    if ($stmt->execute()) {
                                        echo "<div class='alert alert-success'>Brand created successfully!</div>";
                                    } else {
                                        echo "<div class='alert alert-danger'>Error creating brand.</div>";
                                    }
                                } else {
                                    echo "<div class='alert alert-warning'>Brand name is required.</div>";
                                }
                            }
                            ?>
