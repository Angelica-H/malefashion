...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($category_name)) {
        ...
        try {
            ...
            // Xóa giá trị input sau khi tạo thành công
            $_POST['name'] = '';
        } catch (PDOException $e) {
            $error_message = "Failed to create category: " . $e->getMessage();
        }
    }
}
?>
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input required name="name" id="name" placeholder="Category Name" type="text"
                                                    class="form-control" value="<?php echo htmlspecialchars($_POST['name'] ?? ''); ?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group mb-1">
                                            <div class="col-md-9 col-xl-8 offset-md-2">
                                                <a href="category.php" class="border-0 btn btn-outline-danger mr-1">
