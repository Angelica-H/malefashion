...
if (isset($_POST['delete_category'])) {
    ...
    if ($deleteStmt->execute([$category_id])) {
...
$filter = isset($_GET['filter']) ? $_GET['filter'] : 'anytime';

// Xử lý phân trang
$page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$limit = 10; // Số lượng item trên mỗi trang
$offset = ($page - 1) * $limit;
...
// Đếm tổng số category để tính số trang
$countQuery = "SELECT COUNT(*) FROM categories WHERE category_name LIKE :search";
if ($filter === 'this_week') {
    $countQuery .= " AND created_at >= DATE_SUB(CURDATE(), INTERVAL 1 WEEK)";
}
                            ...
                            <div class="card-header">
                                <form>
                                    <div class="input-group">
                                        <input type="search" name="search" id="search" placeholder="Search categories" class="form-control" value="<?php echo htmlspecialchars($search); ?>">
                                ...
                                <div class="btn-actions-pane-right">
                                    <div role="group" class="btn-group-sm btn-group">
                                        <a href="?filter=this_week<?php echo $search ? '&search=' . urlencode($search) : ''; ?>" class="btn btn-focus <?php echo $filter === 'this_week' ? 'active' : ''; ?>">This week</a>
                                        <a href="?filter=anytime<?php echo $search ? '&search=' . urlencode($search) : ''; ?>" class="btn btn-focus <?php echo $filter === 'anytime' ? 'active' : ''; ?>">Anytime</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center text-muted">#<?php echo $category['category_id']; ?></td>
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading"><?php echo htmlspecialchars($category['category_name']); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <a href="./category-edit.php?id=<?php echo $category['category_id']; ?>" data-toggle="tooltip" title="Edit"
                                                    ...
                                                    <form class="d-inline" action="" method="post">
                                                        ...
                                                        <button class="btn btn-hover-shine btn-outline-danger border-0 btn-sm"
                                                            type="submit" name="delete_category" data-toggle="tooltip" title="Delete"
                                        ...
                                        <ul class="pagination justify-content-center">
                                            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                                <li class="page-item <?php echo $page == $i ? 'active' : ''; ?>">
                                                    <a class="page-link" href="?page=<?php echo $i; ?><?php echo $search ? '&search=' . urlencode($search) : ''; ?><?php echo $filter != 'anytime' ? '&filter=' . $filter : ''; ?>">
                                                        <?php echo $i; ?>
                                                    </a>
                                                </li>
                                            <?php endfor; ?>
