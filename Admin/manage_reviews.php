...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['action']) && isset($_POST['id'])) {
        ...
        if ($_POST['action'] == 'approve') {
            $sql = "UPDATE product_reviews SET status = 'approved' WHERE review_id = ?";
...
// Truy vấn SQL cơ bản
$sql = "SELECT pr.review_id, pr.product_id, p.product_name, pr.customer_id, 
...
if (!empty($search)) {
    $sql .= " WHERE p.product_name LIKE ? OR c.first_name LIKE ? OR c.last_name LIKE ? OR pr.comment LIKE ?";
}
...
$countSql = "SELECT COUNT(*) as total FROM product_reviews pr
             ...
             JOIN customers c ON pr.customer_id = c.customer_id";
if (!empty($search)) {
    $countSql .= " WHERE p.product_name LIKE ? OR c.first_name LIKE ? OR c.last_name LIKE ? OR pr.comment LIKE ?";
}
    ...
    <?php include 'includes/app-header.php'; ?>
        ...
        <form action="" method="GET">
            <div class="input-group">
                <input type="search" name="search" id="search"
                    placeholder="Tìm kiếm bình luận" class="form-control" 
        ...
        <div class="btn-actions-pane-right">
            <div role="group" class="btn-group-sm btn-group">
                ...
                <a href="?sort=rating&order=<?php echo $sort == 'rating' && $order == 'DESC' ? 'ASC' : 'DESC'; ?>" 
                   class="btn btn-focus">Sắp xếp theo Đánh giá</a>
                    ...
                    <td class="text-center">
                        ...
                        <form class="d-inline" action="" method="post">
                            ...
                            <button class="btn btn-hover-shine btn-outline-danger border-0 btn-sm"
                                type="submit" onclick="return confirm('Bạn có chắc chắn muốn xóa bình luận này?')">
