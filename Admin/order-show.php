...
try {
    ...
    $items_sql = "SELECT oi.*, p.product_name, p.product_image, pv.size_id, pv.color_id, s.size_name, c.color_name, sk.sku_code
                  FROM order_items oi
                  JOIN product_variants pv ON oi.variant_id = pv.variant_id
                  JOIN products p ON pv.product_id = p.product_id
                  JOIN sizes s ON pv.size_id = s.size_id
                  JOIN colors c ON pv.color_id = c.color_id
                  JOIN sku sk ON oi.sku_id = sk.sku_id
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="../<?php echo htmlspecialchars($item['product_image']); ?>" alt="<?php echo htmlspecialchars($item['product_name']); ?>" class="img-thumbnail mr-3" style="width: 60px;">
                        ...
                        <td class="text-center"><?php echo number_format($item['price'] * $item['quantity'], 0, ',', '.') . ' ₫'; ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
