                                    ...
                                    if(isset($_GET['id']) && isset($_GET['type'])) {
                                        ...
                                        try {
                                            ...
                                            if($user) {
                                                ...
                                                <div class="position-relative row form-group">
                                                    <label for="created_at" class="col-md-3 text-md-right col-form-label">Registration Date</label>
                                                    <div class="col-md-9 col-xl-8">
                                                ...
                                                <div class="position-relative row form-group">
                                                    <label for="address" class="col-md-3 text-md-right col-form-label">Shipping Address</label>
                                                    <div class="col-md-9 col-xl-8">
